      ...
      <fieldset>
        ...
        <table>
          ...
          <tr>
              ...
              <td> <input type="password" id="u-password" name="user-password" style="outline: 0"></td>
          </tr>
          <tr>
              <td><label for="ck-password"/><b style="font-size: 5px">비밀번호 확인</b></td>
              <td> <input type="password" id="ck-password" style="outline: 0"></td>
          </tr>
          <tr>
            <td><label for="u-tel"/><b style="font-size: 5px">휴대폰 번호&nbsp;</b></td>
            <td><input type="tel" id="u-tel" name="user-tel" placeholder="번호 입력" style="outline: 0"></td>
            <td><input type="button" value="중복확인"/></td>
          </tr>
          <tr>
            <td><label for="u-email"/><b style="font-size: 5px">휴대폰 번호&nbsp;</b></td>
        ...
        <hr/>
        <div style="text-align: center; margin-top: 5px">
          <input type="submit" style="width: 200px; font-weight:bold; background-color: #c3aeef; border:none"  value="회원 가입">
        </div>
      </fieldset>
    </form>
</body>
